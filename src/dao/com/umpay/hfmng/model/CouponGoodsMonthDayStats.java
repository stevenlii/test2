/**
 * @ClassName: CouponGoodsMonthDayStats
 * @Description: TODO
 * @author panyouliang
 * @date 2013-3-25 下午1:04:49
 */
 ...
 *
 */
@ExpTypeAnnotation(fieldStr = { "日期(日/月)", "商户编号", "商户名称", "商品编号", "商品名称", "售出数量", "售出总金额 (元)", "兑换数量", "兑换总金额(元)", "注销数量", "注销总金额(元)", "过期数量", "过期总金额(元)" }, 
fieldWidth = {10, 10, 20, 10, 20, 8, 16, 8, 16, 8, 16, 8, 16},
fileName="商品日月统计", sheetName="商品日月统计")
public class CouponGoodsMonthDayStats implements Entity {
