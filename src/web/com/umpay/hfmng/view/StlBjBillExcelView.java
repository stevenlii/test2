...
/**
 * @ClassName: StlBjBillExcelView
 * @Description: 财务结算管理-北京小额账单EXCEL视图
 * @version: 1.0
 * @author: wanyong
 * @Create: 2013-12-17
 */
public class StlBjBillExcelView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		label = new Label(8, 0, outWwb.getSheet(0).getCell(8, 0).getContents()
				.replaceAll("@CREATEDATE", StringUtil.get11Date()), outWwb.getSheet(0).getCell(8, 0).getCellFormat());
		outWwb.getSheet(0).addCell(label);
		...
		outWwb.getSheet(0).addCell(label);
		Number number = new Number(3, 3, couponMerSet.getMuteAmt(), outWwb.getSheet(0).getCell(3, 3).getCellFormat());
		...
		outWwb.getSheet(0).addCell(number);
		number = new Number(5, 3, couponMerSet.getExt1() / 100.0, outWwb.getSheet(0).getCell(5, 3).getCellFormat());
		outWwb.getSheet(0).addCell(number);
		number = new Number(6, 3, couponMerSet.getNbsmNum(), outWwb.getSheet(0).getCell(6, 3).getCellFormat());
		outWwb.getSheet(0).addCell(number);
		number = new Number(7, 3, couponMerSet.getNbsmAmt(), outWwb.getSheet(0).getCell(7, 3).getCellFormat());
		outWwb.getSheet(0).addCell(number);
		number = new Number(8, 3, couponMerSet.getPaybackAmt(), outWwb.getSheet(0).getCell(8, 3).getCellFormat());
		outWwb.getSheet(0).addCell(number);
		number = new Number(9, 3, couponMerSet.getMerStlPay(), outWwb.getSheet(0).getCell(9, 3).getCellFormat());
		outWwb.getSheet(0).addCell(number);
		// 结算周期
	...
	public static void main(String[] args) throws Exception {
		Workbook tmpWwb = Workbook.getWorkbook(new File("d:\\bj-mer-bill-tmp.xls")); // 读取模板EXCEL
		WritableWorkbook outWwb = Workbook.createWorkbook(new File("d:\\bj-mer-bill-tmp11.xls"), tmpWwb);

		jxl.write.Number number = new jxl.write.Number(5, 3, 92.83999989999999, outWwb.getSheet(0).getCell(3, 3)
				.getCellFormat());
		outWwb.getSheet(0).addCell(number);
