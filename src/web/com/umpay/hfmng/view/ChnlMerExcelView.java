/** *****************  JAVA头文件说明  ****************
 * file name  :  ChnlMerExcelView.java
 * owner      :  xu
 * copyright  :  UMPAY
 * description:  
 * modified   :  2013-3-28
...
public class ChnlMerExcelView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model,
		...
		String[] title = { "渠道编号", "渠道名称", "商户号", "商户名称", "商户状态" };
		String fileName = "渠道商户信息.xls";
		// 输出的excel的路径
		// 批量导出
		String sheetNameString = "渠道商户信息列表";
