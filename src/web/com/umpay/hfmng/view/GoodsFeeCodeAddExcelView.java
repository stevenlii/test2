...
public class GoodsFeeCodeAddExcelView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model,
		...
		String[] title = { "更新时间", "商户名称", "商户号", "商品号", "商品名称", "商品一级分类", "商品二级分类", "商品三级分类", "价格(分)", "服务类型" };
		String fileName = "添加商品计费代码信息.xls";
		// 输出的excel的路径
		// 批量导出
		String sheetNameString = "添加商品计费代码信息列表";
