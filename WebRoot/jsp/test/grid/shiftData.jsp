...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/ui/js/om-grid-stand.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/js/ui/js/om-dialog.js"></script>
	<script src="${pageContext.request.contextPath}/js/ui/js/om-validate.js"></script>
    <!-- 
        <script src="../../../js/ui/js/om-validate.js"></script>
    <script src="../../../js/ui/js/om-messagetip.js"></script>
    <script src="../../../js/ui/js/om-draggable.js"></script>
	<script src="../../../js/ui/js/om-position.js"></script>
    <script src="../../../js/ui/js/om-ajaxsubmit.js"></script>
        <link rel="stylesheet" href="../../../js/ui/demos/demo.css">
        <script src="../../../js/ui/js/om-button.js"></script>
            <style>
        #delete{margin-right:20px;}
        #ipForm label {color:red;}
    </style>
     -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/ui/themes/default/om-all.css" />


    <!-- view_source_begin 686-->
    <script type="text/javascript">
        $(document).ready(function() {
             $('#grid2').omGrid({
                dataSource : '${basePath}/hfMngBusi/demo/gridcrud.do',
                width : 1000,
                height : 332,
                limit : 10,
            ...
            $('#grid').omGrid({
                ...
                limit : 10,
                colModel : [ {header : 'ID', name : 'id', width : 50, align : 'center'}, 
                             {header : '地区', name : 'city', width : 120, align : 'left',renderer:function(value , rowData , rowIndex){
                             	var city = rowData.city;
                             	return "<a title='"+city+"'>"+city+"</a>"
                             }}, 
                             {header : '地址', name : 'address', align : 'left', width : 'autoExpand'},
                             {header : '起始IP', name : 'start',width:120},
                             {header : '结束IP', name : 'end',width:120} ]
            ...
            var submitDialog = function(){
                if (validator.form()) {
	                ...
	                $.post('${basePath}/hfMngBusi/demo/gridcrud.do',submitData,function(){
	                    if(isAdd){
            ...
            $('#delete').bind('click', function(e) {
                ...
                $.post('${basePath}/hfMngBusi/demo/gridcrud.do',{operation:'delete',id:toDeleteRecordID},function(){
            ...
            $('#query').bind('click', function(e) {
                ...
                if(qCity===""){ //没要有查询条件，要显示全部数据
                    $('#grid').omGrid("setData", '${basePath}/hfMngBusi/demo/gridcrud.do');
                }else{ //有查询条件，显示查询数据
                    $('#grid').omGrid("setData", '${basePath}/hfMngBusi/demo/gridcrud.do?qCity='+encodeURI(qCity));
                }
            });
            ...
            $('#shift').bind('click', function() {
                ...
                rowData = rowData || {};
                alert(rowData.id+"-"+rowData.city);
                
                var data2 = $('#grid2').omGrid('getData').rows;
                //alert(data2);
                var testRow = data2[0]||{};
                //alert(testRow.id+"-"+testRow.city);
                var i = data2.unshift(rowData);
                //alert(i);
                var t = {"id":999,"city":"金融街","address":"西单金融街","start":"1.198.0.0","end":"1.199.255.255"};
                //var newRow = eval("{'\"id\":999','city:金融街','address:西单金融街','start:1.198.0.0','end:1.199.255.255'}");
                var newRow = t;
                data2.unshift(newRow);
...
<body>
    ...
    <div id="tbdiv">
        ...
        <input id="shift" type="button" value="数据迁移"/>
